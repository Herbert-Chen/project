...
if __name__ == '__main__':
    for var_name in ['Y2','Y3','Y4','Y5','Y6','Y7']:
        ...
        for year_start in [1997,2010]:
            if var_name == 'Y2':
                ...
                otherFeatureList = [12,22, 25,993]
                baseFeatureList = [56, 136, 156, 256, 276, 296, 336, 416, 436, 496, 516, 556, 896,  236,356,116,316,76,916,36,96,816]
            elif var_name == 'Y3':
                # 削减变量Y3
                col_name_dict = {'Total Cash & ST Investments/Avg. monthly cash outflow Month': 676}
                # otherFeatureList = [12, 25,993]
                ...
                #                    556, 596, 616, 636, 656, 796, 816, 836, 856, 876, 896, 916]
                #去掉12
                otherFeatureList = [22, 25,993]
                baseFeatureList = [56, 116, 136, 156, 256, 276, 296, 336, 416, 436, 496, 516, 556, 896,    316,916,236,76,356,96,876]
            elif var_name == 'Y5':
                # 削减变量Y5
                col_name_dict = {'Total Cash & ST Investments/Total Assets %': 736}
                ...
                otherFeatureList = [22, 12, 25,993]
                baseFeatureList = [56, 136, 156, 256, 276, 296, 336, 416, 496, 516, 556, 896,     76,236,916,356,436,316,116,96,876,796]
            elif var_name == 'Y6':
                # #削减变量Y6
                col_name_dict = {'Net Cash Burn Ratio 1=Net Cash 1/ Avg. monthly cash outflow %': 756}
                # otherFeatureList = [12, 25,993]
                ...
                #去掉896
                otherFeatureList = [12,22, 25,993]
                baseFeatureList = [56, 76, 136, 156, 256, 276, 296, 336, 416, 436, 496, 516, 556,     236,36,916,116,356,96,856,816,876]
            elif var_name == 'Y7':
                # 削减变量Y7
                col_name_dict = {'Net Cash 1 / Sales %': 776}
                # otherFeatureList = [12, 25,993]
                ...
                otherFeatureList = [12,22, 25,993]
                baseFeatureList = [56, 76, 116, 136, 156, 256, 276, 296, 416, 436, 496, 516, 556, 896,       236,916,336,316,356,96,816,876]
            elif var_name == 'Y1':
                # 削减变量Y5
