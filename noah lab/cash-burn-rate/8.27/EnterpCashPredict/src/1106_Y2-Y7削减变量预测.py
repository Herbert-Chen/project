    ...
    for var_name in ['Y2','Y3','Y5','Y6','Y7']:
        ...
        for year_start in [1998,2010]:
            if var_name == 'Y2':
                ...
                baseFeatureList = [36,56,76, 96, 116, 136, 156, 236, 256, 276, 296, 316, 336, 356, 416, 436, 496, 516, 556, 816, 896, 916, 936]
            elif var_name == 'Y3':
                # 削减变量Y3
                col_name_dict = {'Total Cash & ST Investments/Avg. monthly cash outflow Month': 676}
                # otherFeatureList = [12, 25,993]
                ...
                baseFeatureList = [56,76,96,116,136,156,236,256,276,296,316,336,356,416,436,496,516,556,876,896,916,936	]
            elif var_name == 'Y5':
                # 削减变量Y5
                col_name_dict = {'Total Cash & ST Investments/Total Assets %': 736}
                ...
                #去掉896
                otherFeatureList = [12,22, 25]
                baseFeatureList = [36,56,76,96,116,136,156,236,256,276,296,336,356,416,436,496,516,556,816,856,876,916,936	]
            elif var_name == 'Y7':
                # 削减变量Y7
                col_name_dict = {'Net Cash 1 / Sales %': 776}
                # otherFeatureList = [12, 25,993]
                ...
                otherFeatureList = [12,22, 25]
                baseFeatureList = [56,76,96,116,136,156,236,256,276,296,316,336,356,416,436,496,516,556,816,876,896,916,936]
            elif var_name == 'Y1':
                # 削减变量Y5
        ...
        ###所有变量循环
                for dev_label in [2,3]:
                    ...
                    for k, v in col_name_dict.items():
                        ...
                        ###预测16-20
                        future_Data = pd.read_excel('../data/future_' + var_name + '_1106.xlsx', sheetname='Sheet1')
