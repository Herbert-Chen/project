...
if __name__ == '__main__':
    ...
    for k,v in col_name_dict.items():
        ...
        otherFeatureList = [23, 24]     # unique features   ###新增cash flow risk，25列,删除12列(11)，直接用23
        ...
        plt = ArkPlot()
        plt_out_name = '../result/1.2/' + 'cv_Y2' + algo + '_gap_' +str(year_gap) + '_last_'+str(year_last) + '.png'        ###
        ...
        ###
        plt_hw = ArkPlot()
        plt_hw_out_name = '../result/1.2/' + 'testone_Y2' + '_' + algo + '_gap_' +str(year_gap) + '_last_'+str(year_last) +  '.png'

        print train_data_set.shape

        logger_file_name = '../result/1.2/testone_Y2_' + algo + '_gap_' +str(year_gap) + '_last_'+str(year_last) +  '.txt'
        logger = open(logger_file_name, 'w')
        min_error = []
        mean_error = []
        median_error = []
        ...
        pyplot.title(k)
        pyplot.xlabel('year')
        pyplot.savefig('../result/1.2/' + 'contrast' + '_Y2_' + algo + '_gap_' +str(year_gap) + '_last_'+str(year_last) +  '.png')
        pyplot.legend()
        pyplot.close()
